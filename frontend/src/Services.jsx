...
function Services() {
  ...
  return (
    <>
      {/* Services Section */}
      <section id="services" className="container mx-auto px-6 md:px-8 lg:px-12 py-16 md:py-24">
        ...
        <div className="container mx-auto px-6 md:px-8 lg:px-12 pb-16 md:pb-24">
          {loading && (
