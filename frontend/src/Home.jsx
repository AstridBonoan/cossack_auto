    ...
    <>
      ...
      <section className="container mx-auto px-6 md:px-8 py-16 md:py-32">
        <div className="max-w-4xl mx-auto text-center">
          <h1 className="text-5xl md:text-7xl font-heading font-bold text-charcoal mb-2 tracking-tight">
            COSSACK AUTO
          </h1>
          <p className="text-muted-gray text-lg md:text-xl uppercase tracking-wide mb-6 font-body">
            AUTO REPAIR & SERVICE
          </p>
