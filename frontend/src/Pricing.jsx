...
function Pricing() {
  ...
  return (
    <>
      ...
      {/* Pricing Tiers */}
      <section className="container mx-auto px-6 md:px-8 pb-16 md:pb-24">
      ...
      <section className="container mx-auto px-6 md:px-8 pb-16 md:pb-24">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="h-1 w-20 bg-cossack-red mx-auto mb-12"></div>
          ...
          <div className="mt-8 text-center">
            <p className="text-muted-gray text-sm font-body mb-4">
              * Prices may vary based on vehicle make, model, and specific requirements.
            </p>
            <Link
              to="/reservation"
              className="inline-block bg-cossack-red hover:bg-cossack-red/90 text-off-white font-heading font-bold py-4 px-8 uppercase tracking-wide text-lg transition-colors"
            >
              Get a Quote
            </Link>
          </div>
      ...
      <section className="container mx-auto px-6 md:px-8 pb-16 md:pb-24">
        <div className="max-w-3xl mx-auto bg-off-white border border-border-gray p-8 md:p-10">
          <h3 className="text-2xl font-heading font-bold text-charcoal mb-4 uppercase tracking-tight">
            Transparent Pricing
          </h3>
